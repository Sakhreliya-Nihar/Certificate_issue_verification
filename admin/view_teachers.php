...
<body class="bg-gray-100">
    ...
    <div class="flex h-screen">
        ...
        <div class="flex-1 overflow-y-auto md:ml-64">
            ...
            <header class="sticky top-0 z-20 flex items-center justify-between border-b border-gray-200 bg-white p-4 shadow-sm">
                ...
                <a href="../logout" class="hidden rounded-lg bg-red-600 px-5 py-2.5 text-sm font-medium text-white shadow-md transition-colors hover:bg-red-700 md:block">
                    Logout
                </a>
            </header>
                ...
                <div id="detailsModal" class="relative overflow-x-auto bg-white p-6 shadow-lg rounded-xl">
                    ...
                    <div class="flex flex-col md:flex-row justify-between items-center mb-4">
                        <form onsubmit="searchTeachers(); return false;" class="flex-grow md:mr-4 mb-2 md:mb-0">
                            <div class="relative">
                                <input type="text" id="searchInput" onkeyup="searchTeachers()" placeholder="Search for names..." class="w-full rounded-lg border border-gray-300 p-2.5 pl-10 text-sm text-gray-900 focus:border-indigo-500 focus:ring-indigo-500">
    ...
    <script>
        ...
        function viewDetails(teacher_id) {
            ...
            xhttp.open("GET", "get_teacher_details?teacher_id=" + teacher_id, true);
            xhttp.send();
        }
                ...
                xhttp.onreadystatechange = function() {
                    if (this.readyState == 4 && this.status == 200) {
                        if (this.responseText.trim() === 'success') {
                            ...
                            alert('Error deleting teacher: ' + this.responseText);
                        }
                    }
                };
                // UPDATED TO CLEAN URL
                xhttp.open("GET", "delete_teacher?teacher_id=" + teacher_id, true);
                xhttp.send();
            }
        }

        // Function to search the table (Added onkeyup to the input field so it searches as you type)
        ...
        function exportData() {
            ...
            // UPDATED TO CLEAN URL
            xhttp.open("GET", "export_teacher_data", true);
            xhttp.send();
        }
    </script>
